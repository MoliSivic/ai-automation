...
const features = [
  {
    icon: BookOpen,
    title: "Import Study Files",
    description: "Upload PDF or TXT notes and turn them into a deck",
  },
  {
    icon: Sparkles,
    title: "Gemini Flashcards",
    description: "Generate questions and answers from extracted note content",
  },
  {
    icon: Brain,
    title: "Anki Export",
    description: "Download an .apkg file ready to import into Anki",
  },
  {
    icon: Zap,
    title: "Study Faster",
    description: "Review generated cards and track each study session",
  },
];

const benefits = [
  "Upload PDF and TXT lecture notes",
  "AI generates cards from extracted text",
  "Export Anki .apkg decks",
  "Track your study progress",
  "Edit cards before studying",
];
      ...
      <section className="pt-24 sm:pt-32 pb-12 sm:pb-20 px-4 sm:px-6 relative overflow-hidden">
        ...
        <div className="container mx-auto text-center max-w-4xl">
          ...
          <h1 className="font-display text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-4 sm:mb-6 animate-fade-in leading-tight">
            ...
            <span className="gradient-text">Anki Flashcards</span>
          </h1>

          <p className="text-base sm:text-lg md:text-xl text-muted-foreground mb-6 sm:mb-8 max-w-2xl mx-auto animate-fade-in px-2">
            Upload lecture notes, let AI create question-answer cards, and
            export an Anki deck for faster review.
          </p>
